...
namespace PhoneBookCSharp {
    ...
    public partial class Database1DataSet1 : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string ContactName, string ContactNumber) {
        ...
        public partial class TableRow : global::System.Data.DataRow {
            ...
            public string ContactNumber {
                get {
                    return ((string)(this[this.tableTable.ContactNumberColumn]));
                }
                set {
                    this[this.tableTable.ContactNumberColumn] = value;
                }
            }
        }
...
namespace PhoneBookCSharp.Database1DataSet1TableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Table] WHERE (([Id] = @Original_Id) AND ([ContactName] = @Orig" +
                "inal_ContactName) AND ([ContactNumber] = @Original_ContactNumber))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [ContactName], [ContactNumber]) VALUES (@Id, @Co" +
                "ntactName, @ContactNumber);\r\nSELECT Id, ContactName, ContactNumber FROM [Table] " +
                "WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Table] SET [Id] = @Id, [ContactName] = @ContactName, [ContactNumber] = @ContactNumber WHERE (([Id] = @Original_Id) AND ([ContactName] = @Original_ContactName) AND ([ContactNumber] = @Original_ContactNumber));
SELECT Id, ContactName, ContactNumber FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::PhoneBookCSharp.Properties.Settings.Default.Database1ConnectionString;
        }
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, ContactName, ContactNumber FROM dbo.[Table]";
        ...
        public virtual int Delete(int Original_Id, string Original_ContactName, string Original_ContactNumber) {
        ...
        public virtual int Insert(int Id, string ContactName, string ContactNumber) {
        ...
        public virtual int Update(int Id, string ContactName, string ContactNumber, int Original_Id, string Original_ContactName, string Original_ContactNumber) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string ContactName, string ContactNumber, int Original_Id, string Original_ContactName, string Original_ContactNumber) {
            return this.Update(Original_Id, ContactName, ContactNumber, Original_Id, Original_ContactName, Original_ContactNumber);
        }
    }
