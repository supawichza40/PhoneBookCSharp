...
namespace PhoneBookCSharp {
    ...
    public partial class Database1DataSet : global::System.Data.DataSet {
        ...
        public partial class TableDataTable : global::System.Data.TypedTableBase<TableRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "16.0.0.0")]
            public TableRow AddTableRow(int Id, string Name, string Number) {
...
namespace PhoneBookCSharp.Database1DataSetTableAdapters {
    ...
    public partial class TableTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Table] ([Id], [Name], [Number]) VALUES (@Id, @Name, @Number);\r" +
                "\nSELECT Id, Name, Number FROM [Table] WHERE (Id = @Id)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE [dbo].[Table] SET [Id] = @Id, [Name] = @Name, [Number] = @Number WHERE (([" +
                "Id] = @Original_Id) AND ([Name] = @Original_Name) AND ([Number] = @Original_Numb" +
                "er));\r\nSELECT Id, Name, Number FROM [Table] WHERE (Id = @Id)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT Id, Name, Number FROM dbo.[Table]";
        ...
        public virtual int Insert(int Id, string Name, string Number) {
        ...
        public virtual int Update(int Id, string Name, string Number, int Original_Id, string Original_Name, string Original_Number) {
